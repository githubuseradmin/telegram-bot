...
CREATE TABLE `callback_query` (
  `callback_query` varchar(255) NOT NULL,
  `status` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`callback_query`)
...
INSERT INTO `settings` VALUES ('name','Test Bot'),('status','0');
...
INSERT INTO `statistics` VALUES (1,'0000-00-00',0,0,0);
...
-- Dump completed on 2020-12-04 19:24:52
